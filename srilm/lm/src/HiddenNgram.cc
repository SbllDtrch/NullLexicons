...
#ifndef lint
static char Copyright[] = "Copyright (c) 1999-2012 SRI International.  All Rights Reserved.";
static char RcsId[] = "@(#)$Header: /home/srilm/CVS/srilm/lm/src/HiddenNgram.cc,v 1.25 2012/10/18 20:55:21 mcintyre Exp $";
#endif
...
HiddenNgram::readHiddenVocab(File &file)
{
	...
	unsigned deleteWords;
	unsigned repeatWords;
	char *insertWord;
	int isObserved;
	int omitFromContext;
	Option options[] = {
...
HiddenNgram::writeHiddenVocab(File &file)
{
	...
	if (props->repeatWords) {
	    fprintf(file, " -%s %u", PROP_REPEAT, props->repeatWords);
	}
